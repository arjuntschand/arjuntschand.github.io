...
export const EXPERIENCE: Experience[] = [
  ...
  },
  {
    ...
    highlights: [
      'Built PyTorch training pipelines for distributionally robust optimization (GroupDRO) on heterogeneous, multimodal datasets, improving worst-group accuracy by +15.0% on NHANES CVD.',
  ...
  },
  {
    ...
    image: {
      ...
      alt: 'Arjun Tschand with Michael Bloomberg, Bloomberg L.P. internship 2025',
  ...
  },
  {
    ...
    image: {
      ...
      alt: 'Arjun Tschand with Michael Bloomberg, Bloomberg L.P. internship 2024',
  ...
  },
  {
    ...
    highlights: [
      'Built a cross-platform Phaser.js Whack-a-Mole fan-engagement game for the NFL Baltimore Ravens, reaching 635,380 in-stadium fans during the 2023–24 season; collaborated with Ravens stakeholders and designers.',
      'Implemented gameplay scenes, animations, and leaderboard logic with cross-device compatibility across iOS, Android, and large in-stadium displays.',
    ],
  },
  {
